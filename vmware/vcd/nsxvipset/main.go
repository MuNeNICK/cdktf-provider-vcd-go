...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NsxvIpSet)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isInheritanceAllowed", GoGetter: "IsInheritanceAllowed"},
			_jsii_.MemberProperty{JsiiProperty: "isInheritanceAllowedInput", GoGetter: "IsInheritanceAllowedInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIsInheritanceAllowed", GoMethod: "ResetIsInheritanceAllowed"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NsxvIpSetConfig)(nil)).Elem(),
	)
}
