...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdVmSizingPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdVmSizingPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.dataVcdVmSizingPolicy.DataVcdVmSizingPolicyCpu",
		reflect.TypeOf((*DataVcdVmSizingPolicyCpu)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdVmSizingPolicy.DataVcdVmSizingPolicyCpuList",
		reflect.TypeOf((*DataVcdVmSizingPolicyCpuList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdVmSizingPolicyCpuOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdVmSizingPolicyMemory)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdVmSizingPolicy.DataVcdVmSizingPolicyMemoryList",
		reflect.TypeOf((*DataVcdVmSizingPolicyMemoryList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdVmSizingPolicyMemoryOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
