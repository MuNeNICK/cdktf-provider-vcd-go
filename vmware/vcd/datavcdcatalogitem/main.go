...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdCatalogItem)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "catalogItemMetadata", GoGetter: "CatalogItemMetadata"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdCatalogItemConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.dataVcdCatalogItem.DataVcdCatalogItemFilter",
		reflect.TypeOf((*DataVcdCatalogItemFilter)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.dataVcdCatalogItem.DataVcdCatalogItemFilterMetadata",
		reflect.TypeOf((*DataVcdCatalogItemFilterMetadata)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdCatalogItem.DataVcdCatalogItemFilterMetadataList",
		reflect.TypeOf((*DataVcdCatalogItemFilterMetadataList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdCatalogItemFilterMetadataOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdCatalogItemFilterOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdCatalogItemMetadataEntry)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdCatalogItem.DataVcdCatalogItemMetadataEntryList",
		reflect.TypeOf((*DataVcdCatalogItemMetadataEntryList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdCatalogItemMetadataEntryOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
