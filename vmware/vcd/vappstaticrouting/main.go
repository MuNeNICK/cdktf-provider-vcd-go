...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VappStaticRouting)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VappStaticRoutingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.vappStaticRouting.VappStaticRoutingRule",
		reflect.TypeOf((*VappStaticRoutingRule)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.vappStaticRouting.VappStaticRoutingRuleList",
		reflect.TypeOf((*VappStaticRoutingRuleList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VappStaticRoutingRuleOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
