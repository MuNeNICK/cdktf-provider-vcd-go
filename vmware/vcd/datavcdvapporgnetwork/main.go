...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdVappOrgNetwork)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isFenced", GoGetter: "IsFenced"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdVappOrgNetworkConfig)(nil)).Elem(),
	)
}
