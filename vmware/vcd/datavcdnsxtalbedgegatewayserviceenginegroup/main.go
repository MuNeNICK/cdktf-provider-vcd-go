...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtAlbEdgegatewayServiceEngineGroup)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServiceEngineGroupId", GoMethod: "ResetServiceEngineGroupId"},
			_jsii_.MemberMethod{JsiiMethod: "resetServiceEngineGroupName", GoMethod: "ResetServiceEngineGroupName"},
			...
			_jsii_.MemberProperty{JsiiProperty: "serviceEngineGroupName", GoGetter: "ServiceEngineGroupName"},
			_jsii_.MemberProperty{JsiiProperty: "serviceEngineGroupNameInput", GoGetter: "ServiceEngineGroupNameInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdNsxtAlbEdgegatewayServiceEngineGroupConfig)(nil)).Elem(),
	)
}
