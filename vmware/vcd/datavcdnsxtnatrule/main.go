...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtNatRule)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "appPortProfileId", GoGetter: "AppPortProfileId"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "constructNodeMetadata", GoGetter: "ConstructNodeMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "count", GoGetter: "Count"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "description", GoGetter: "Description"},
			_jsii_.MemberProperty{JsiiProperty: "dnatExternalPort", GoGetter: "DnatExternalPort"},
			...
			_jsii_.MemberProperty{JsiiProperty: "firewallMatch", GoGetter: "FirewallMatch"},
			...
			_jsii_.MemberProperty{JsiiProperty: "internalAddress", GoGetter: "InternalAddress"},
			...
			_jsii_.MemberProperty{JsiiProperty: "snatDestinationAddress", GoGetter: "SnatDestinationAddress"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdNsxtNatRuleConfig)(nil)).Elem(),
	)
}
