...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ExternalNetwork)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRetainNetInfoAcrossDeployments", GoMethod: "ResetRetainNetInfoAcrossDeployments"},
			_jsii_.MemberProperty{JsiiProperty: "retainNetInfoAcrossDeployments", GoGetter: "RetainNetInfoAcrossDeployments"},
			_jsii_.MemberProperty{JsiiProperty: "retainNetInfoAcrossDeploymentsInput", GoGetter: "RetainNetInfoAcrossDeploymentsInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ExternalNetworkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.externalNetwork.ExternalNetworkIpScope",
		reflect.TypeOf((*ExternalNetworkIpScope)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.externalNetwork.ExternalNetworkIpScopeList",
		reflect.TypeOf((*ExternalNetworkIpScopeList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ExternalNetworkIpScopeOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ExternalNetworkIpScopeStaticIpPool)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.externalNetwork.ExternalNetworkIpScopeStaticIpPoolList",
		reflect.TypeOf((*ExternalNetworkIpScopeStaticIpPoolList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ExternalNetworkIpScopeStaticIpPoolOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ExternalNetworkVsphereNetwork)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.externalNetwork.ExternalNetworkVsphereNetworkList",
		reflect.TypeOf((*ExternalNetworkVsphereNetworkList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ExternalNetworkVsphereNetworkOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
