...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdTask)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "cancelRequested", GoGetter: "CancelRequested"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdTaskConfig)(nil)).Elem(),
	)
}
