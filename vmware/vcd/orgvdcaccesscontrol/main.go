...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OrgVdcAccessControl)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OrgVdcAccessControlConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.orgVdcAccessControl.OrgVdcAccessControlSharedWith",
		reflect.TypeOf((*OrgVdcAccessControlSharedWith)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.orgVdcAccessControl.OrgVdcAccessControlSharedWithList",
		reflect.TypeOf((*OrgVdcAccessControlSharedWithList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OrgVdcAccessControlSharedWithOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
