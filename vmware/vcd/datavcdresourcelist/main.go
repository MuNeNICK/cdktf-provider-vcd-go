...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdResourceList)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "listMode", GoGetter: "ListMode"},
			_jsii_.MemberProperty{JsiiProperty: "listModeInput", GoGetter: "ListModeInput"},
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "nameIdSeparator", GoGetter: "NameIdSeparator"},
			_jsii_.MemberProperty{JsiiProperty: "nameIdSeparatorInput", GoGetter: "NameIdSeparatorInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetListMode", GoMethod: "ResetListMode"},
			_jsii_.MemberMethod{JsiiMethod: "resetNameIdSeparator", GoMethod: "ResetNameIdSeparator"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdResourceListConfig)(nil)).Elem(),
	)
}
