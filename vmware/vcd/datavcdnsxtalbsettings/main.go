...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtAlbSettings)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ipv6ServiceNetworkSpecification", GoGetter: "Ipv6ServiceNetworkSpecification"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServiceNetworkSpecification", GoMethod: "ResetServiceNetworkSpecification"},
			_jsii_.MemberMethod{JsiiMethod: "resetVdc", GoMethod: "ResetVdc"},
			_jsii_.MemberProperty{JsiiProperty: "serviceNetworkSpecification", GoGetter: "ServiceNetworkSpecification"},
			_jsii_.MemberProperty{JsiiProperty: "serviceNetworkSpecificationInput", GoGetter: "ServiceNetworkSpecificationInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdNsxtAlbSettingsConfig)(nil)).Elem(),
	)
}
