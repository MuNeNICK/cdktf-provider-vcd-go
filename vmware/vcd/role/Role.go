...
import (
	...
	"github.com/munenick/cdktf-provider-vcd-go/vmware/vcd/role/internal"
...
// Represents a {@link https://registry.terraform.io/providers/vmware/vcd/3.10.0/docs/resources/role vcd_role}.
type Role interface {
...
func (j *jsiiProxy_Role) BundleKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bundleKey",
...
func (j *jsiiProxy_Role) Org() *string {
	var returns *string
	_jsii_.Get(
		j,
		"org",
...
func (j *jsiiProxy_Role) OrgInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"orgInput",
...
func (j *jsiiProxy_Role) ReadOnly() cdktf.IResolvable {
...
func (j *jsiiProxy_Role) Rights() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"rights",
...
func (j *jsiiProxy_Role) RightsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"rightsInput",
...
// Create a new {@link https://registry.terraform.io/providers/vmware/vcd/3.10.0/docs/resources/role vcd_role} Resource.
...
func (j *jsiiProxy_Role)SetOrg(val *string) {
...
func (j *jsiiProxy_Role)SetRights(val *[]*string) {
...
func (r *jsiiProxy_Role) ResetOrg() {
	_jsii_.InvokeVoid(
		r,
		"resetOrg",
		nil, // no parameters
...
func (r *jsiiProxy_Role) ResetRights() {
	_jsii_.InvokeVoid(
		r,
		"resetRights",
		nil, // no parameters
