...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VappOrgNetwork)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isFencedInput", GoGetter: "IsFencedInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIsFenced", GoMethod: "ResetIsFenced"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VappOrgNetworkConfig)(nil)).Elem(),
	)
}
