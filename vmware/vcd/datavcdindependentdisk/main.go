...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdIndependentDisk)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdIndependentDiskConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.dataVcdIndependentDisk.DataVcdIndependentDiskMetadataEntry",
		reflect.TypeOf((*DataVcdIndependentDiskMetadataEntry)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdIndependentDisk.DataVcdIndependentDiskMetadataEntryList",
		reflect.TypeOf((*DataVcdIndependentDiskMetadataEntryList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdIndependentDiskMetadataEntryOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
