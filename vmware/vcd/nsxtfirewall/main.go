...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NsxtFirewall)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NsxtFirewallConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.nsxtFirewall.NsxtFirewallRule",
		reflect.TypeOf((*NsxtFirewallRule)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.nsxtFirewall.NsxtFirewallRuleList",
		reflect.TypeOf((*NsxtFirewallRuleList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NsxtFirewallRuleOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
