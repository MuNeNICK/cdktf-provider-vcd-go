...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VappAccessControl)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VappAccessControlConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.vappAccessControl.VappAccessControlSharedWith",
		reflect.TypeOf((*VappAccessControlSharedWith)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.vappAccessControl.VappAccessControlSharedWithList",
		reflect.TypeOf((*VappAccessControlSharedWithList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VappAccessControlSharedWithOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
