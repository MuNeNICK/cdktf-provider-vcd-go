...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxvDhcpRelay)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdNsxvDhcpRelayConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.dataVcdNsxvDhcpRelay.DataVcdNsxvDhcpRelayRelayAgent",
		reflect.TypeOf((*DataVcdNsxvDhcpRelayRelayAgent)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdNsxvDhcpRelay.DataVcdNsxvDhcpRelayRelayAgentList",
		reflect.TypeOf((*DataVcdNsxvDhcpRelayRelayAgentList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxvDhcpRelayRelayAgentOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
