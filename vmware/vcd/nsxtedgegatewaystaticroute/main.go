...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NsxtEdgegatewayStaticRoute)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NsxtEdgegatewayStaticRouteConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.nsxtEdgegatewayStaticRoute.NsxtEdgegatewayStaticRouteNextHop",
		reflect.TypeOf((*NsxtEdgegatewayStaticRouteNextHop)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.nsxtEdgegatewayStaticRoute.NsxtEdgegatewayStaticRouteNextHopList",
		reflect.TypeOf((*NsxtEdgegatewayStaticRouteNextHopList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NsxtEdgegatewayStaticRouteNextHopOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NsxtEdgegatewayStaticRouteNextHopScope)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.nsxtEdgegatewayStaticRoute.NsxtEdgegatewayStaticRouteNextHopScopeOutputReference",
		reflect.TypeOf((*NsxtEdgegatewayStaticRouteNextHopScopeOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
