...
import (
	...
	"github.com/munenick/cdktf-provider-vcd-go/vmware/vcd/apitoken/internal"
...
// Represents a {@link https://registry.terraform.io/providers/vmware/vcd/3.10.0/docs/resources/api_token vcd_api_token}.
...
func (j *jsiiProxy_ApiToken) AllowTokenFile() interface{} {
...
func (j *jsiiProxy_ApiToken) AllowTokenFileInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"allowTokenFileInput",
...
func (j *jsiiProxy_ApiToken) FileName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fileName",
...
func (j *jsiiProxy_ApiToken) FileNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fileNameInput",
...
// Create a new {@link https://registry.terraform.io/providers/vmware/vcd/3.10.0/docs/resources/api_token vcd_api_token} Resource.
...
func (j *jsiiProxy_ApiToken)SetAllowTokenFile(val interface{}) {
...
func (j *jsiiProxy_ApiToken)SetFileName(val *string) {
