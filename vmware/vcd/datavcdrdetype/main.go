...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdRdeType)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "inheritedVersion", GoGetter: "InheritedVersion"},
			_jsii_.MemberProperty{JsiiProperty: "interfaceIds", GoGetter: "InterfaceIds"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "lifecycle", GoGetter: "Lifecycle"},
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberProperty{JsiiProperty: "nss", GoGetter: "Nss"},
			_jsii_.MemberProperty{JsiiProperty: "nssInput", GoGetter: "NssInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdRdeTypeConfig)(nil)).Elem(),
	)
}
