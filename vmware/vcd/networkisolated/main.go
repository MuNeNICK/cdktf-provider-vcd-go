...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkIsolated)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkIsolatedConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.networkIsolated.NetworkIsolatedDhcpPool",
		reflect.TypeOf((*NetworkIsolatedDhcpPool)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.networkIsolated.NetworkIsolatedDhcpPoolList",
		reflect.TypeOf((*NetworkIsolatedDhcpPoolList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkIsolatedDhcpPoolOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkIsolatedMetadataEntry)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.networkIsolated.NetworkIsolatedMetadataEntryList",
		reflect.TypeOf((*NetworkIsolatedMetadataEntryList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkIsolatedMetadataEntryOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkIsolatedStaticIpPool)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.networkIsolated.NetworkIsolatedStaticIpPoolList",
		reflect.TypeOf((*NetworkIsolatedStaticIpPoolList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkIsolatedStaticIpPoolOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
