...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdVappNetwork)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdVappNetworkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.dataVcdVappNetwork.DataVcdVappNetworkDhcpPool",
		reflect.TypeOf((*DataVcdVappNetworkDhcpPool)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdVappNetwork.DataVcdVappNetworkDhcpPoolList",
		reflect.TypeOf((*DataVcdVappNetworkDhcpPoolList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdVappNetworkDhcpPoolOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdVappNetworkStaticIpPool)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdVappNetwork.DataVcdVappNetworkStaticIpPoolList",
		reflect.TypeOf((*DataVcdVappNetworkStaticIpPoolList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdVappNetworkStaticIpPoolOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
