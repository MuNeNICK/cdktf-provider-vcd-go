...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtSecurityGroup)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdNsxtSecurityGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.dataVcdNsxtSecurityGroup.DataVcdNsxtSecurityGroupMemberVms",
		reflect.TypeOf((*DataVcdNsxtSecurityGroupMemberVms)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdNsxtSecurityGroup.DataVcdNsxtSecurityGroupMemberVmsList",
		reflect.TypeOf((*DataVcdNsxtSecurityGroupMemberVmsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtSecurityGroupMemberVmsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
