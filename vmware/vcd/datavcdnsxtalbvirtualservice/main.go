...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtAlbVirtualService)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdNsxtAlbVirtualServiceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.dataVcdNsxtAlbVirtualService.DataVcdNsxtAlbVirtualServiceServicePort",
		reflect.TypeOf((*DataVcdNsxtAlbVirtualServiceServicePort)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdNsxtAlbVirtualService.DataVcdNsxtAlbVirtualServiceServicePortList",
		reflect.TypeOf((*DataVcdNsxtAlbVirtualServiceServicePortList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtAlbVirtualServiceServicePortOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
