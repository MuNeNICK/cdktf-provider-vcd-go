...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdVmAffinityRule)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "polarity", GoGetter: "Polarity"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdVmAffinityRuleConfig)(nil)).Elem(),
	)
}
