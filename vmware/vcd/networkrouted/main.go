...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkRouted)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkRoutedConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.networkRouted.NetworkRoutedDhcpPool",
		reflect.TypeOf((*NetworkRoutedDhcpPool)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.networkRouted.NetworkRoutedDhcpPoolList",
		reflect.TypeOf((*NetworkRoutedDhcpPoolList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkRoutedDhcpPoolOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkRoutedMetadataEntry)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.networkRouted.NetworkRoutedMetadataEntryList",
		reflect.TypeOf((*NetworkRoutedMetadataEntryList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkRoutedMetadataEntryOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkRoutedStaticIpPool)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.networkRouted.NetworkRoutedStaticIpPoolList",
		reflect.TypeOf((*NetworkRoutedStaticIpPoolList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkRoutedStaticIpPoolOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
