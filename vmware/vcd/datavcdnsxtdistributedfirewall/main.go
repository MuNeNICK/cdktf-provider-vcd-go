...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtDistributedFirewall)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdNsxtDistributedFirewallConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.dataVcdNsxtDistributedFirewall.DataVcdNsxtDistributedFirewallRule",
		reflect.TypeOf((*DataVcdNsxtDistributedFirewallRule)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdNsxtDistributedFirewall.DataVcdNsxtDistributedFirewallRuleList",
		reflect.TypeOf((*DataVcdNsxtDistributedFirewallRuleList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtDistributedFirewallRuleOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
