...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxvApplication)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "appGuid", GoGetter: "AppGuid"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdNsxvApplicationConfig)(nil)).Elem(),
	)
}
