...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VmAffinityRule)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "polarityInput", GoGetter: "PolarityInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*VmAffinityRuleConfig)(nil)).Elem(),
	)
}
