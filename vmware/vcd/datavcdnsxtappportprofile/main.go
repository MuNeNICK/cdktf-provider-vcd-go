...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtAppPortProfile)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "appPort", GoGetter: "AppPort"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "constructNodeMetadata", GoGetter: "ConstructNodeMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "contextId", GoGetter: "ContextId"},
			_jsii_.MemberProperty{JsiiProperty: "contextIdInput", GoGetter: "ContextIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetContextId", GoMethod: "ResetContextId"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetNsxtManagerId", GoMethod: "ResetNsxtManagerId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdNsxtAppPortProfileAppPort)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdNsxtAppPortProfile.DataVcdNsxtAppPortProfileAppPortList",
		reflect.TypeOf((*DataVcdNsxtAppPortProfileAppPortList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtAppPortProfileAppPortOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdNsxtAppPortProfileConfig)(nil)).Elem(),
	)
}
