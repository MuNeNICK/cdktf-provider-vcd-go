...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtEdgegatewayBgpIpPrefixList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdNsxtEdgegatewayBgpIpPrefixListConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.dataVcdNsxtEdgegatewayBgpIpPrefixList.DataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefix",
		reflect.TypeOf((*DataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefix)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdNsxtEdgegatewayBgpIpPrefixList.DataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefixList",
		reflect.TypeOf((*DataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefixList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtEdgegatewayBgpIpPrefixListIpPrefixOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
