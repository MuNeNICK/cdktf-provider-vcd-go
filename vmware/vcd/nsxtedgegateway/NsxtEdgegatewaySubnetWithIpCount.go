...
type NsxtEdgegatewaySubnetWithIpCount struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.10.0/docs/resources/nsxt_edgegateway#allocated_ip_count NsxtEdgegateway#allocated_ip_count}
	AllocatedIpCount *float64 `field:"required" json:"allocatedIpCount" yaml:"allocatedIpCount"`
