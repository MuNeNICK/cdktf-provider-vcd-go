...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NsxtNetworkDhcpBinding)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dhcpV4Config", GoGetter: "DhcpV4Config"},
			_jsii_.MemberProperty{JsiiProperty: "dhcpV4ConfigInput", GoGetter: "DhcpV4ConfigInput"},
			_jsii_.MemberProperty{JsiiProperty: "dhcpV6Config", GoGetter: "DhcpV6Config"},
			_jsii_.MemberProperty{JsiiProperty: "dhcpV6ConfigInput", GoGetter: "DhcpV6ConfigInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "leaseTimeInput", GoGetter: "LeaseTimeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDhcpV4Config", GoMethod: "PutDhcpV4Config"},
			_jsii_.MemberMethod{JsiiMethod: "putDhcpV6Config", GoMethod: "PutDhcpV6Config"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetDhcpV4Config", GoMethod: "ResetDhcpV4Config"},
			_jsii_.MemberMethod{JsiiMethod: "resetDhcpV6Config", GoMethod: "ResetDhcpV6Config"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NsxtNetworkDhcpBindingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.nsxtNetworkDhcpBinding.NsxtNetworkDhcpBindingDhcpV4Config",
		reflect.TypeOf((*NsxtNetworkDhcpBindingDhcpV4Config)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.nsxtNetworkDhcpBinding.NsxtNetworkDhcpBindingDhcpV4ConfigOutputReference",
		reflect.TypeOf((*NsxtNetworkDhcpBindingDhcpV4ConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NsxtNetworkDhcpBindingDhcpV6Config)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.nsxtNetworkDhcpBinding.NsxtNetworkDhcpBindingDhcpV6ConfigOutputReference",
		reflect.TypeOf((*NsxtNetworkDhcpBindingDhcpV6ConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSntpServers", GoMethod: "ResetSntpServers"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "sntpServers", GoGetter: "SntpServers"},
			_jsii_.MemberProperty{JsiiProperty: "sntpServersInput", GoGetter: "SntpServersInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
