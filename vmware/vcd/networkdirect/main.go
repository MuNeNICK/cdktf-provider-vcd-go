...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkDirect)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "externalNetworkDns1", GoGetter: "ExternalNetworkDns1"},
			_jsii_.MemberProperty{JsiiProperty: "externalNetworkDns2", GoGetter: "ExternalNetworkDns2"},
			_jsii_.MemberProperty{JsiiProperty: "externalNetworkDnsSuffix", GoGetter: "ExternalNetworkDnsSuffix"},
			_jsii_.MemberProperty{JsiiProperty: "externalNetworkGateway", GoGetter: "ExternalNetworkGateway"},
			_jsii_.MemberProperty{JsiiProperty: "externalNetworkInput", GoGetter: "ExternalNetworkInput"},
			_jsii_.MemberProperty{JsiiProperty: "externalNetworkNetmask", GoGetter: "ExternalNetworkNetmask"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkDirectConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.networkDirect.NetworkDirectMetadataEntry",
		reflect.TypeOf((*NetworkDirectMetadataEntry)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.networkDirect.NetworkDirectMetadataEntryList",
		reflect.TypeOf((*NetworkDirectMetadataEntryList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkDirectMetadataEntryOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
