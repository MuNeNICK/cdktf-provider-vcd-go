...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkRoutedV2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkRoutedV2Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.networkRoutedV2.NetworkRoutedV2MetadataEntry",
		reflect.TypeOf((*NetworkRoutedV2MetadataEntry)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.networkRoutedV2.NetworkRoutedV2MetadataEntryList",
		reflect.TypeOf((*NetworkRoutedV2MetadataEntryList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkRoutedV2MetadataEntryOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkRoutedV2SecondaryStaticIpPool)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.networkRoutedV2.NetworkRoutedV2SecondaryStaticIpPoolList",
		reflect.TypeOf((*NetworkRoutedV2SecondaryStaticIpPoolList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkRoutedV2SecondaryStaticIpPoolOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NetworkRoutedV2StaticIpPool)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.networkRoutedV2.NetworkRoutedV2StaticIpPoolList",
		reflect.TypeOf((*NetworkRoutedV2StaticIpPoolList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NetworkRoutedV2StaticIpPoolOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
