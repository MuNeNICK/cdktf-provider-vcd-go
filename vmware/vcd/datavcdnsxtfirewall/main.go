...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtFirewall)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdNsxtFirewallConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.dataVcdNsxtFirewall.DataVcdNsxtFirewallRule",
		reflect.TypeOf((*DataVcdNsxtFirewallRule)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdNsxtFirewall.DataVcdNsxtFirewallRuleList",
		reflect.TypeOf((*DataVcdNsxtFirewallRuleList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtFirewallRuleOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
