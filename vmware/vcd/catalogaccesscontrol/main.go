...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CatalogAccessControl)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "everyoneAccessLevel", GoGetter: "EveryoneAccessLevel"},
			_jsii_.MemberProperty{JsiiProperty: "everyoneAccessLevelInput", GoGetter: "EveryoneAccessLevelInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putSharedWith", GoMethod: "PutSharedWith"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetEveryoneAccessLevel", GoMethod: "ResetEveryoneAccessLevel"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOrg", GoMethod: "ResetOrg"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetSharedWith", GoMethod: "ResetSharedWith"},
			_jsii_.MemberProperty{JsiiProperty: "sharedWith", GoGetter: "SharedWith"},
			_jsii_.MemberProperty{JsiiProperty: "sharedWithEveryone", GoGetter: "SharedWithEveryone"},
			_jsii_.MemberProperty{JsiiProperty: "sharedWithEveryoneInput", GoGetter: "SharedWithEveryoneInput"},
			_jsii_.MemberProperty{JsiiProperty: "sharedWithInput", GoGetter: "SharedWithInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CatalogAccessControlConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.catalogAccessControl.CatalogAccessControlSharedWith",
		reflect.TypeOf((*CatalogAccessControlSharedWith)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.catalogAccessControl.CatalogAccessControlSharedWithList",
		reflect.TypeOf((*CatalogAccessControlSharedWithList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CatalogAccessControlSharedWithOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
