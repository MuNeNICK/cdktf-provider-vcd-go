...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdLbServerPool)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdLbServerPoolConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.dataVcdLbServerPool.DataVcdLbServerPoolMember",
		reflect.TypeOf((*DataVcdLbServerPoolMember)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdLbServerPool.DataVcdLbServerPoolMemberList",
		reflect.TypeOf((*DataVcdLbServerPoolMemberList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdLbServerPoolMemberOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
