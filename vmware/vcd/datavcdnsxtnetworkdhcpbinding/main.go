...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtNetworkDhcpBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdNsxtNetworkDhcpBindingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"vcd.dataVcdNsxtNetworkDhcpBinding.DataVcdNsxtNetworkDhcpBindingDhcpV4Config",
		reflect.TypeOf((*DataVcdNsxtNetworkDhcpBindingDhcpV4Config)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdNsxtNetworkDhcpBinding.DataVcdNsxtNetworkDhcpBindingDhcpV4ConfigList",
		reflect.TypeOf((*DataVcdNsxtNetworkDhcpBindingDhcpV4ConfigList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtNetworkDhcpBindingDhcpV4ConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdNsxtNetworkDhcpBindingDhcpV6Config)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"vcd.dataVcdNsxtNetworkDhcpBinding.DataVcdNsxtNetworkDhcpBindingDhcpV6ConfigList",
		reflect.TypeOf((*DataVcdNsxtNetworkDhcpBindingDhcpV6ConfigList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdNsxtNetworkDhcpBindingDhcpV6ConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
