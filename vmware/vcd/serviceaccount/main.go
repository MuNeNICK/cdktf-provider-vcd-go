...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowTokenFile", GoGetter: "AllowTokenFile"},
			_jsii_.MemberProperty{JsiiProperty: "allowTokenFileInput", GoGetter: "AllowTokenFileInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAllowTokenFile", GoMethod: "ResetAllowTokenFile"},
			...
			_jsii_.MemberProperty{JsiiProperty: "softwareId", GoGetter: "SoftwareId"},
			_jsii_.MemberProperty{JsiiProperty: "softwareIdInput", GoGetter: "SoftwareIdInput"},
