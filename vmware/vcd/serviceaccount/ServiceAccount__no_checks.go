...
func (j *jsiiProxy_ServiceAccount) validateSetActiveParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_ServiceAccount) validateSetAllowTokenFileParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_ServiceAccount) validateSetFileNameParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_ServiceAccount) validateSetOrgParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_ServiceAccount) validateSetRoleIdParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_ServiceAccount) validateSetSoftwareIdParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_ServiceAccount) validateSetSoftwareVersionParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_ServiceAccount) validateSetUriParameters(val *string) error {
	return nil
}
