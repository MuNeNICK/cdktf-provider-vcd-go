...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NsxtEdgegatewayDhcpForwarding)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dhcpServers", GoGetter: "DhcpServers"},
			_jsii_.MemberProperty{JsiiProperty: "dhcpServersInput", GoGetter: "DhcpServersInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NsxtEdgegatewayDhcpForwardingConfig)(nil)).Elem(),
	)
}
