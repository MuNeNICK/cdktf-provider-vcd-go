...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*InsertedMedia)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ejectForce", GoGetter: "EjectForce"},
			_jsii_.MemberProperty{JsiiProperty: "ejectForceInput", GoGetter: "EjectForceInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEjectForce", GoMethod: "ResetEjectForce"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*InsertedMediaConfig)(nil)).Elem(),
	)
}
