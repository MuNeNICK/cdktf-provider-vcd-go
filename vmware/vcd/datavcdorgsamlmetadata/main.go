...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataVcdOrgSamlMetadata)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "metadataText", GoGetter: "MetadataText"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataVcdOrgSamlMetadataConfig)(nil)).Elem(),
	)
}
